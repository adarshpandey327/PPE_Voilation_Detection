...
def create_message(sender, to, subject, message_text, attachment):
    ...
    # maintype, subtype = type_subtype.split('/')   // for image 
    ...
    mime_message.add_attachment(attachment_data, maintype="application ", subtype="pdf", filename=attachment_filename)
...
if __name__ == "__main__":
    ...
    prepare_and_send_email('devksingh3444@gmail.com', 'Greeting from Adarsh Pandey', 'This is assigned task in nvidia training to send pdf file', 'pdf.pdf')
